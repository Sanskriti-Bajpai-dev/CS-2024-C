    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        combine_letter_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // when this button is clicked navigate to combine letter activity
                // before that we have create combine letter activity
                // now add start activity
                // now we have created a copy of camera activity
