      ...
      //  float[][][]result=new float[1][10][4];
        ...
        for (int i=0;i<10;i++){
            ...
            if(score_value>0.5){
                ...
                Log.d("objectDectectionClass","output_class_value: "+output_class_value[0][0]);
                ...
                Imgproc.rectangle(rotated_mat_image,new Point(x1,y1),new Point(x2,y2),new Scalar(0, 255, 0, 255),2);
                   // noe we will change layout we are done with sign language recogniton part
                // now combine letter function to our sign language
